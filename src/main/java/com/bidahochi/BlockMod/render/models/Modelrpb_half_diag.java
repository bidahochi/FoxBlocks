...
public class Modelrpb_half_diag extends ModelConverter //Same as Filename
{
	int textureX = 64;
	int textureY = 32;

	public Modelrpb_half_diag() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[1].setRotationPoint(-9F, 17.98F, -9F);

		bodyModel[2].addBox(0F, 0F, 0F, 2, 0, 2, 0F); // Box 2
		bodyModel[2].setRotationPoint(7F, 17.98F, 7F);
	}
}