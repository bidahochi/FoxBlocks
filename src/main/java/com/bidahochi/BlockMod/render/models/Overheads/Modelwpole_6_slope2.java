...
public class Modelwpole_6_slope2 extends ModelConverter //Same as Filename
{
	int textureX = 256;
	int textureY = 128;

	public Modelwpole_6_slope2() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[21] = new ModelRendererTurbo(this, 1, 1, textureX, textureY); // Box 26
		bodyModel[22] = new ModelRendererTurbo(this, 25, 1, textureX, textureY); // Box 27
		bodyModel[23] = new ModelRendererTurbo(this, 22, 49, textureX, textureY); // Box 28
		bodyModel[24] = new ModelRendererTurbo(this, 17, 1, textureX, textureY); // Box 29
		bodyModel[25] = new ModelRendererTurbo(this, 25, 1, textureX, textureY); // Box 30
		...
		bodyModel[0].setRotationPoint(-41F, -54F, -17F);
		...
		bodyModel[16].setRotationPoint(-41F, -55F, -17F);
		...
		bodyModel[17].setRotationPoint(-40.5F, -55F, -16.5F);
		...
		bodyModel[21].addBox(0F, 0F, 0F, 4, 89, 4, 0F); // Box 26
		bodyModel[21].setRotationPoint(-42F, -79F, -50F);

		bodyModel[22].addBox(0F, 0F, 0F, 2, 2, 38, 0F); // Box 27
		bodyModel[22].setRotationPoint(-41F, -53F, -46F);

		bodyModel[23].addBox(0F, 0F, 0F, 1, 0, 34, 0F); // Box 28
		bodyModel[23].setRotationPoint(-40.5F, -68F, -47F);
		bodyModel[23].rotateAngleX = -0.4712389F;

		bodyModel[24].addBox(0F, 0F, 0F, 1, 0, 2, 0F); // Box 29
		bodyModel[24].setRotationPoint(-40.5F, -68F, -52F);

		bodyModel[25].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 30
		bodyModel[25].setRotationPoint(-40.5F, -68.5F, -51F);
	}
}