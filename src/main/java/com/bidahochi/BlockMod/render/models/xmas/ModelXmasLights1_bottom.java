...
public class ModelXmasLights1_bottom extends ModelConverter //Same as Filename
{
	int textureX = 32;
	int textureY = 32;

	public ModelXmasLights1_bottom() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(8F, 3F, -8F);
		...
		bodyModel[1].setRotationPoint(7F, 3.47F, -7F);
		...
		bodyModel[2].setRotationPoint(7F, 3.47F, 6F);
		...
		bodyModel[3].setRotationPoint(7F, 3.94F, -3.75F);
		...
		bodyModel[4].setRotationPoint(7F, 3.94F, 2.75F);
		...
		bodyModel[5].setRotationPoint(7F, 4.4F, -0.5F);
		...
		bodyModel[6].setRotationPoint(7F, 4.4F, -0.5F);
		...
		bodyModel[7].setRotationPoint(7F, 3.94F, 2.75F);
		...
		bodyModel[8].setRotationPoint(7F, 3.94F, -3.75F);
		...
		bodyModel[9].setRotationPoint(7F, 3.47F, 6F);
		...
		bodyModel[10].setRotationPoint(7F, 3.47F, -7F);
