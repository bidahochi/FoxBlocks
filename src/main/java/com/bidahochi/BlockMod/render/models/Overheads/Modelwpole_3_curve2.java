...
public class Modelwpole_3_curve2 extends ModelConverter //Same as Filename
{
	int textureX = 256;
	int textureY = 128;

	public Modelwpole_3_curve2() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(2F, -70F, -51F);
		bodyModel[0].rotateAngleY = -2.35619449F;

		bodyModel[1].addBox(-1F, 0F, 5F, 2, 2, 38, 0F); // Box 1
		bodyModel[1].setRotationPoint(-28F, -45F, -20F);
		bodyModel[1].rotateAngleY = -2.35619449F;

		bodyModel[2].addBox(-0.5F, 0F, 0F, 1, 0, 34, 0F); // Box 2
		bodyModel[2].setRotationPoint(-19F, -45F, -29F);
		bodyModel[2].rotateAngleX = 0.4712389F;
		bodyModel[2].rotateAngleY = -2.35619449F;

		bodyModel[3].addBox(-0.5F, 0F, 0F, 1, 0, 2, 0F); // Box 3
		bodyModel[3].setRotationPoint(3.8F, -59F, -52F);
		bodyModel[3].rotateAngleY = -2.35619449F;

		bodyModel[4].addBox(-0.5F, 0F, 0F, 1, 1, 1, 0F); // Box 4
		bodyModel[4].setRotationPoint(3.8F, -59.5F, -52F);
		bodyModel[4].rotateAngleY = -2.35619449F;
