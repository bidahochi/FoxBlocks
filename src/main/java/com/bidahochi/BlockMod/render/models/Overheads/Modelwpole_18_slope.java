...
public class Modelwpole_18_slope extends ModelConverter//Same as Filename
{
	int textureX = 512;
	int textureY = 128;

	public Modelwpole_18_slope() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(-138F, -79F, 14.5F);

		bodyModel[1].addBox(0F, 0F, 0F, 2, 2, 38, 0F); // Box 1
		bodyModel[1].setRotationPoint(-137F, -53F, -23.5F);

		bodyModel[2].addBox(0F, 0F, 0F, 1, 0, 2, 0F); // Box 3
		bodyModel[2].setRotationPoint(-136.5F, -68F, 18.5F);

		bodyModel[3].addBox(0F, 0F, 0F, 1, 1, 1, 0F); // Box 4
		bodyModel[3].setRotationPoint(-136.5F, -68.5F, 18.5F);
		...
		bodyModel[32].setRotationPoint(-136.5F, -53F, -14.5F);
