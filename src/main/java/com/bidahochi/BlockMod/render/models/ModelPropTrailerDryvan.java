...
public class ModelPropTrailerDryvan extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 128;

	public ModelPropTrailerDryvan() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[1] = new ModelRendererTurbo(this, 241, 53, textureX, textureY); // Box 71 wheel 3
		bodyModel[2] = new ModelRendererTurbo(this, 230, 53, textureX, textureY); // Box 74 wheel 3
		bodyModel[3] = new ModelRendererTurbo(this, 230, 64, textureX, textureY); // Box 76 wheel 3
		bodyModel[4] = new ModelRendererTurbo(this, 231, 59, textureX, textureY); // Box 77 wheel 3
		bodyModel[5] = new ModelRendererTurbo(this, 241, 64, textureX, textureY); // Box 71 wheel 3
		bodyModel[6] = new ModelRendererTurbo(this, 218, 47, textureX, textureY); // Box 71 wheel 3b
		bodyModel[7] = new ModelRendererTurbo(this, 218, 53, textureX, textureY); // Box 77 wheel 3b
		bodyModel[8] = new ModelRendererTurbo(this, 218, 64, textureX, textureY); // Box 71 wheel 3b
		bodyModel[9] = new ModelRendererTurbo(this, 218, 47, textureX, textureY); // Box 71 wheel 4b
		bodyModel[10] = new ModelRendererTurbo(this, 218, 53, textureX, textureY); // Box 77 wheel 4b
		bodyModel[11] = new ModelRendererTurbo(this, 218, 64, textureX, textureY); // Box 71 wheel 4b
		bodyModel[12] = new ModelRendererTurbo(this, 241, 53, textureX, textureY); // Box 71 wheel 4
		bodyModel[13] = new ModelRendererTurbo(this, 230, 53, textureX, textureY); // Box 74 wheel 4 
		bodyModel[14] = new ModelRendererTurbo(this, 230, 64, textureX, textureY); // Box 76 wheel 4
		bodyModel[15] = new ModelRendererTurbo(this, 241, 64, textureX, textureY); // Box 71 wheel 4
		bodyModel[16] = new ModelRendererTurbo(this, 231, 59, textureX, textureY); // Box 77 wheel 4
		bodyModel[17] = new ModelRendererTurbo(this, 192, 52, textureX, textureY); // Box 124 axle 3-4
		bodyModel[18] = new ModelRendererTurbo(this, 241, 53, textureX, textureY); // Box 71 wheel 3
		bodyModel[19] = new ModelRendererTurbo(this, 230, 53, textureX, textureY); // Box 74 wheel 3
		bodyModel[20] = new ModelRendererTurbo(this, 230, 64, textureX, textureY); // Box 76 wheel 3
		bodyModel[21] = new ModelRendererTurbo(this, 231, 59, textureX, textureY); // Box 77 wheel 3
		bodyModel[22] = new ModelRendererTurbo(this, 241, 64, textureX, textureY); // Box 71 wheel 3
		bodyModel[23] = new ModelRendererTurbo(this, 218, 47, textureX, textureY); // Box 71 wheel 3b
		bodyModel[24] = new ModelRendererTurbo(this, 218, 53, textureX, textureY); // Box 77 wheel 3b
		bodyModel[25] = new ModelRendererTurbo(this, 218, 64, textureX, textureY); // Box 71 wheel 3b
		bodyModel[26] = new ModelRendererTurbo(this, 218, 47, textureX, textureY); // Box 71 wheel 4b
		bodyModel[27] = new ModelRendererTurbo(this, 218, 53, textureX, textureY); // Box 77 wheel 4b
		bodyModel[28] = new ModelRendererTurbo(this, 218, 64, textureX, textureY); // Box 71 wheel 4b
		bodyModel[29] = new ModelRendererTurbo(this, 241, 53, textureX, textureY); // Box 71 wheel 4
		bodyModel[30] = new ModelRendererTurbo(this, 230, 53, textureX, textureY); // Box 74 wheel 4 
		...
		bodyModel[48] = new ModelRendererTurbo(this, 201, 81, textureX, textureY); // Box 247 turnlight L
		bodyModel[49] = new ModelRendererTurbo(this, 208, 81, textureX, textureY); // Box 186 taillight
		bodyModel[50] = new ModelRendererTurbo(this, 201, 81, textureX, textureY); // Box 187 turnlight R
		bodyModel[51] = new ModelRendererTurbo(this, 208, 81, textureX, textureY); // Box 188 taillight
		...
		bodyModel[97] = new ModelRendererTurbo(this, 205, 46, textureX, textureY); // Box 101 wheel 3 cover
		...
		bodyModel[69].setRotationPoint(-42.5F, 4.5F, -4.5F);

		bodyModel[70].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 169
		bodyModel[70].setRotationPoint(-42.5F, 4.5F, 3.5F);
		...
		bodyModel[95].setRotationPoint(-42.5F, 9F, -4.5F);
		...
		bodyModel[96].setRotationPoint(-42.5F, 9F, 3.5F);
