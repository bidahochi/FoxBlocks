...
public class Modelwpole_5_curve2 extends ModelConverter //Same as Filename
{
	int textureX = 256;
	int textureY = 128;

	public Modelwpole_5_curve2() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[23] = new ModelRendererTurbo(this, 176, 58, textureX, textureY); // Box 1
		bodyModel[24] = new ModelRendererTurbo(this, 190, 60, textureX, textureY); // Box 2
		bodyModel[25] = new ModelRendererTurbo(this, 222, 57, textureX, textureY); // Box 3
		bodyModel[26] = new ModelRendererTurbo(this, 225, 54, textureX, textureY); // Box 4
		...
		bodyModel[1].addShapeBox(-1F, 0F, -33F, 1, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 82
		bodyModel[1].setRotationPoint(-66.05F, -47F, -14.05F);
		bodyModel[1].rotateAngleY = 0.80285146F;

		bodyModel[2].addShapeBox(-1F, 0F, -33.5F, 2, 1, 2, 0F,0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F); // Box 83
		bodyModel[2].setRotationPoint(-66.5F, -47F, -14.5F);
		bodyModel[2].rotateAngleY = 0.80285146F;

		bodyModel[3].addShapeBox(-1F, 0F, -33.5F, 2, 1, 2, 0F,0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F, 0F, -0.125F, -0.125F); // Box 84
		bodyModel[3].setRotationPoint(-66.5F, -46F, -14.5F);
		...
		bodyModel[22].addBox(-2F, 0F, -2F, 4, 81, 4, 0F); // Box 0
		bodyModel[22].setRotationPoint(-21F, -70F, -60F);
		bodyModel[22].rotateAngleY = -2.35619449F;

		bodyModel[23].addBox(-1F, 0F, 5F, 2, 2, 38, 0F); // Box 1
		bodyModel[23].setRotationPoint(-51F, -45F, -29F);
		bodyModel[23].rotateAngleY = -2.35619449F;

		bodyModel[24].addBox(-0.5F, 0F, 0F, 1, 0, 34, 0F); // Box 2
		bodyModel[24].setRotationPoint(-42F, -45F, -38F);
		bodyModel[24].rotateAngleX = 0.4712389F;
		bodyModel[24].rotateAngleY = -2.35619449F;

		bodyModel[25].addBox(-0.5F, 0F, 0F, 1, 0, 2, 0F); // Box 3
		bodyModel[25].setRotationPoint(-19.2F, -59F, -61F);
		bodyModel[25].rotateAngleY = -2.35619449F;

		bodyModel[26].addBox(-0.5F, 0F, 0F, 1, 1, 1, 0F); // Box 4
		bodyModel[26].setRotationPoint(-19.2F, -59.5F, -61F);
