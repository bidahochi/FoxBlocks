...
public class ModelbridgeA_Xside_Top2 extends ModelConverter //Same as Filename
{
	int textureX = 256;
	int textureY = 32;

	public ModelbridgeA_Xside_Top2() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].addBox(0F, -6F, 0F, 97, 6, 1, 0F); // Box 41
		bodyModel[0].setRotationPoint(-1F, 74F, 7F);
		bodyModel[0].rotateAngleX = -0.12217305F;

		bodyModel[1].addBox(0F, -6F, 0F, 120, 6, 1, 0F); // Box 42
		bodyModel[1].setRotationPoint(-1F, 74F, 6F);
		bodyModel[1].rotateAngleX = -0.12217305F;
		bodyModel[1].rotateAngleY = 0.07853982F;
		bodyModel[1].rotateAngleZ = 0.5846853F;

		bodyModel[2].addBox(0F, -6F, -1F, 120, 6, 1, 0F); // Box 43
		bodyModel[2].setRotationPoint(96F, 74F, 6F);
		bodyModel[2].rotateAngleX = 0.12217305F;
		bodyModel[2].rotateAngleY = 3.05432619F;
