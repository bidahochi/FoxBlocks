...
@SideOnly(Side.CLIENT)
    public class RenderXmasLights1_bottom_white extends TileEntitySpecialRenderer {
        ...
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileXmasLights1_bottom_white)){return;}
            GL11.glPushMatrix();
            Tessellator.bindTexture(texture2);
            GL11.glTranslated(x + 0.5, y + 0.62, z + 0.5);
            GL11.glRotatef(180F, 1F, 0F, 0F);
            GL11.glRotatef(90F, 0F, 1F, 0F);
            int dir = ((TileXmasLights1_bottom_white)tileEntity).dir;
            switch(dir) {
                case 0:{//west // north
