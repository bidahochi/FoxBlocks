...
@SideOnly(Side.CLIENT)
    public class RenderToilet extends TileEntitySpecialRenderer {
        private ResourceLocation texture2 = new ResourceLocation(FoxBlocks.MODID, "textures/blocks/wall_toilet.png");
        private ModelWallToilet model = new ModelWallToilet();

        @Override
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileToilet)){return;}
            GL11.glPushMatrix();
            ...
            int dir = ((TileToilet)tileEntity).dir;
