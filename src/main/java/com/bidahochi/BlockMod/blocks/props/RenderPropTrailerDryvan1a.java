...
@SideOnly(Side.CLIENT)
    public class RenderPropTrailerDryvan1a extends TileEntitySpecialRenderer {
        ...
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TilePropTrailerDryvan1a)){return;}
            GL11.glPushMatrix();
            Tessellator.bindTexture(texture2);
            GL11.glTranslated(x + 0.5, y + 0.625, z + 0.5);
            GL11.glRotatef(180F, 1F, 0F, 0F);
            GL11.glRotatef(90F, 0F, 1F, 0F);
            int dir = ((TilePropTrailerDryvan1a)tileEntity).dir;
            switch(dir) {
                case 0:{//west // north
