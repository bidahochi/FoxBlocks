...
public class PropTrailerDryvan1 extends BlockContainer {
    public PropTrailerDryvan1(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("propTrailerDryvan1");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TilePropTrailerDryvan1();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TilePropTrailerDryvan1(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
