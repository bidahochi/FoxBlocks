...
public class PropTrailerDryvan1a extends BlockContainer {
    public PropTrailerDryvan1a(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("propTrailerDryvan1a");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TilePropTrailerDryvan1a();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TilePropTrailerDryvan1a(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
