...
/*public class DoorA2 extends BlockDoor {
    @SideOnly(Side.CLIENT)
    public IIcon[] iiconA;
    @SideOnly(Side.CLIENT)
    public IIcon[] iiconB;

    public DoorA2(Material mat) {
        super(mat);
        setBlockName("doorA");
        setHardness(3F);
        //setResistance(6.5F);
    ...
    {
        return (itemDropped & 8) != 0 ? null : (this.blockMaterial == Material.iron ? Items.iron_door : ItemIDs.doorA);
    }
}*/
