...
public class ClampOnSignDerail extends BlockContainer {
    public ClampOnSignDerail(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("clampOnSignDerail");
        setHardness(1F);
        setResistance(1.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileClampOnSignDerail();
    }
   ...
   public boolean canCollideCheck(int p_149678_1_, boolean p_149678_2_){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileClampOnSignDerail(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
