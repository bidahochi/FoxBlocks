...
public class Soda_machine extends BlockContainer {
    public Soda_machine(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("soda_machine");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileSoda_machine(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
