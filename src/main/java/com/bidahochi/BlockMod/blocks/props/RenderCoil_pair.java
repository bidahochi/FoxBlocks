...
import com.bidahochi.BlockMod.render.models.Modelcoil_pair;
...
@SideOnly(Side.CLIENT)
    public class RenderCoil_pair extends TileEntitySpecialRenderer {
        private ResourceLocation texture2 = new ResourceLocation(FoxBlocks.MODID, "textures/blocks/props/coils.png");
        private Modelcoil_pair model = new Modelcoil_pair();

        @Override
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileCoil_pair)){return;}
            GL11.glPushMatrix();
            ...
            int dir = ((TileCoil_pair)tileEntity).dir;
