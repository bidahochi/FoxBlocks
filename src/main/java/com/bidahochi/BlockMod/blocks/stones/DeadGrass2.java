...
public class DeadGrass2 extends Block {

    public IIcon [] textures = new IIcon[6];

    public DeadGrass2(Material p_i45394_1_) {
        super(p_i45394_1_);
        setStepSound(soundTypeGrass);
        setHardness(0.5F);
        setResistance(0.1F);
        setHarvestLevel("shovel", 0);
        setBlockName(BlockIDs.deadGrass2.blockName);
        setBlockTextureName(FoxBlocks.MODID+":aggregates/grasses/dead_grass2");
