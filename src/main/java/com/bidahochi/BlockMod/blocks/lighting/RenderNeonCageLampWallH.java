...
@SideOnly(Side.CLIENT)
    public class RenderNeonCageLampWallH extends TileEntitySpecialRenderer {
        private ResourceLocation texture = new ResourceLocation(FoxBlocks.MODID, "textures/blocks/lighting/NeonCageLight.png");
        private ModelNeonCageLight model3 = new ModelNeonCageLight();

        @Override
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileNeonCageLampWallH)){return;}
            GL11.glPushMatrix();
            ...
            int dir = ((TileNeonCageLampWallH)tileEntity).dir;
            ...
            model3.render(null, 0, 0, 0, 0, 0, 0.0625f);
            GL11.glPopMatrix();
        }
    }