...
public class NeonCageLampWallV extends BlockContainer {
    public NeonCageLampWallV(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("neonCageLampWallV");
        setHardness(2F);
        setResistance(6.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileNeonCageLampWallV();
    }
   ...
   public boolean canCollideCheck(int p_149678_1_, boolean p_149678_2_){
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((TileNeonCageLampWallV)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileNeonCageLampWallV(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID+ ":neonCageLampWallV_icon");
    }
}
