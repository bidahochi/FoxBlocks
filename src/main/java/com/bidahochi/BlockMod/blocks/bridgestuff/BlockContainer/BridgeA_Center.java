...
public class BridgeA_Center extends BlockContainer implements IFoxBlocksScrollingBlock {
    public BridgeA_Center(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("bridgeA_Center");
        setHardness(2F);
        setResistance(6.0F);
   ...
   public boolean canCollideCheck(int p_149678_1_, boolean p_149678_2_){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileBridgeA_Center(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
