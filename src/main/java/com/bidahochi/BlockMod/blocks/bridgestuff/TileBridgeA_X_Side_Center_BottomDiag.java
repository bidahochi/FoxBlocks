...
public class TileBridgeA_X_Side_Center_BottomDiag extends BaseTileEntity
{
    public TileBridgeA_X_Side_Center_BottomDiag(int dir)
    {
        super(dir);
    }

    public TileBridgeA_X_Side_Center_BottomDiag()
    {
