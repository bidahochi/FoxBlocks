...
public class BridgeA_X_Side_BottomDiag extends BlockContainer implements IFoxBlocksScrollingBlock {
    public BridgeA_X_Side_BottomDiag(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("bridgeA_X_Side_BottomDiag");
        setHardness(2F);
        setResistance(6.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileBridgeA_X_Side_Center_BottomDiag();
    }
   ...
   public boolean canCollideCheck(int p_149678_1_, boolean p_149678_2_){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileBridgeA_X_Side_Center_BottomDiag(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
