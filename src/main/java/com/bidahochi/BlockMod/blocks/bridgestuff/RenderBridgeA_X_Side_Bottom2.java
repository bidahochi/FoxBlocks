...
@SideOnly(Side.CLIENT)
    public class RenderBridgeA_X_Side_Bottom2 extends TileEntitySpecialRenderer {
        ...
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileBridgeA_X_Side_Center_Bottom2)){return;}
            GL11.glPushMatrix();
            ...
            int dir = ((TileBridgeA_X_Side_Center_Bottom2)tileEntity).dir;
