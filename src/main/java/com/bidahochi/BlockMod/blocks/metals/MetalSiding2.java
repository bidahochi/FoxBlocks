...
public class MetalSiding2 extends Block {

    public IIcon[] textures = new IIcon[16];

    public MetalSiding2(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("metalSiding2");
        setBlockTextureName(FoxBlocks.MODID+":metals/metalsiding2/metalsiding");
