...
public class StallPart_Edge1 extends BlockContainer implements IFoxBlocksScrollingBlock {
    public StallPart_Edge1(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("stallPart_Edge1");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileStallPart_Edge1();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileStallPart_Edge1(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID + ":props/stallPartsE1");
    }
