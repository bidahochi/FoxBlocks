...
import com.bidahochi.BlockMod.render.models.RoadCovers.ModelRoadCoverDynamicNorthSouth1X2;
import com.bidahochi.BlockMod.render.models.RoadCovers.ModelRoadCoverDynamicEastWest1X2;
...
public class RenderDynamicRoadCover1X2 extends TileEntitySpecialRenderer
{
    private ModelRoadCoverDynamicNorthSouth1X2 modelNorthSouth1X2 = new ModelRoadCoverDynamicNorthSouth1X2();
    private ModelRoadCoverDynamicEastWest1X2 modelEastWest1X2 = new ModelRoadCoverDynamicEastWest1X2();
    private String[] roadCoverTexture = new String[2];

    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick)
    {
        if(!(tileEntity instanceof TileRoadCoverDynamic1X2))
        {
            return;
        }

        TileRoadCoverDynamic1X2 tileRoadCoverDynamic = ((TileRoadCoverDynamic1X2)tileEntity);
        String texture;
        ...
        switch (tileRoadCoverDynamic.dir)
        {
            case 3: //east
                ...
                modelNorthSouth1X2.render(null, 0, 0, 0, 0, 0, 0.0625f);
            break;
            case 1: //west
            ...
            case 2: // north
                GL11.glTranslated(0,0,0);
                modelEastWest1X2.render(null, 0, 0, 0, 0, 0, 0.0625f);
                break;
            case 0: //south
