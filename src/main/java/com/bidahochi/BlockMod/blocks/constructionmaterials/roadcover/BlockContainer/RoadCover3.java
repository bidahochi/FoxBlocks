...
import com.bidahochi.BlockMod.blocks.constructionmaterials.roadcover.TileEntity.TileRoadCover3;
...
public class RoadCover3 extends BlockContainer {
    public RoadCover3(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("roadcover_tarmac_3");
        setHardness(2F);
        setResistance(4.0F);
   ...
   public boolean canCollideCheck(int p_149678_1_, boolean p_149678_2_){
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        if(world == null || !(world.getTileEntity(x,y,z) instanceof TileRoadCover3)){
            super.setBlockBoundsBasedOnState(world,x,y,z);
            return;
        }
        //return based on tile data
        switch(((TileRoadCover3)world.getTileEntity(x,y,z)).dir){
            case 0:
            case 1:
            case 2:
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileRoadCover3(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID+ ":constructionmaterials/tarmac/tarmac_3");
    }
}
