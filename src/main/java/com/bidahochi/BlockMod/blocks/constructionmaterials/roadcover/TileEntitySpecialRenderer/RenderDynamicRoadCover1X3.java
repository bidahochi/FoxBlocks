...
import com.bidahochi.BlockMod.render.models.RoadCovers.ModelRoadCoverDynamicEastWest1X3;
import com.bidahochi.BlockMod.render.models.RoadCovers.ModelRoadCoverDynamicNorthSouth1X3;
...
public class RenderDynamicRoadCover1X3 extends TileEntitySpecialRenderer
{
    private ModelRoadCoverDynamicNorthSouth1X3 modelNorthSouth1X3 = new ModelRoadCoverDynamicNorthSouth1X3();
    private ModelRoadCoverDynamicEastWest1X3 modelEastWest1X3 = new ModelRoadCoverDynamicEastWest1X3();
    private String[] roadCoverTexture = new String[2];

    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick)
    {
        if(!(tileEntity instanceof TileRoadCoverDynamic1X3))
        {
            return;
        }

        TileRoadCoverDynamic1X3 tileRoadCoverDynamic = ((TileRoadCoverDynamic1X3)tileEntity);
        String texture;
        ...
        switch (tileRoadCoverDynamic.dir)
        {
            case 3: //east
                ...
                modelNorthSouth1X3.render(null, 0, 0, 0, 0, 0, 0.0625f);
            break;
            case 1: //west
            ...
            case 2: // north
                GL11.glTranslated(0,0,0);
                modelEastWest1X3.render(null, 0, 0, 0, 0, 0, 0.0625f);
                break;
            case 0: //south
