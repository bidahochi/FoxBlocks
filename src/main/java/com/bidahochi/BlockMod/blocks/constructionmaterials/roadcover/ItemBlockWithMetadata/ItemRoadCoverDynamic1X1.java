...
public class ItemRoadCoverDynamic1X1 extends ItemBlockWithMetadata
{
    public ItemRoadCoverDynamic1X1(Block block) {
        super(block, block);
    }
    ...
    public boolean onItemUse(ItemStack itemstack, EntityPlayer player, World world, int x, int y, int z, int par7, float par8, float par9, float par10)
    {
        ...
        {
            world.setBlock(x, y + 1, z, BlockIDs.roadcover_dynamic1x1.block, MathHelper.floor_double((player != null ? player.rotationYaw : par10) * 4.0F / 360.0F + 0.5D) & 3, 3);
            TileRoadCoverDynamic1X1 roadCoverDynamic = (TileRoadCoverDynamic1X1) world.getTileEntity(x, y + 1, z);
