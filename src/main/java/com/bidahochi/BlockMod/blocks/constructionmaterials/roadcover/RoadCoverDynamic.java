...
public class RoadCoverDynamic extends BlockContainer
{
    public RoadCoverDynamic(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("roadcover_dynamic");
        setHardness(2F);
        setResistance(4.0F);
    ...
    {
        return new TileRoadCoverDynamic(meta);
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) 
    {
        ...
        if(world == null || !(world.getTileEntity(x,y,z) instanceof TileRoadCoverDynamic)){
            super.setBlockBoundsBasedOnState(world,x,y,z);
            return;
        }
        //return based on tile data
        switch(((TileRoadCoverDynamic)world.getTileEntity(x,y,z)).dir){
            case 0:
            case 1:
            case 2:
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack)
    {
        ...
        TileRoadCoverDynamic tile = new TileRoadCoverDynamic(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3);
