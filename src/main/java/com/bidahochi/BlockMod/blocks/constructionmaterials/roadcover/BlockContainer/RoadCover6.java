...
public class RoadCover6 extends BlockContainer {
    public RoadCover6(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("roadcover_tarmac_6");
        setHardness(2F);
        setResistance(4.0F);
   ...
   public boolean canCollideCheck(int p_149678_1_, boolean p_149678_2_){
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        if(world == null || !(world.getTileEntity(x,y,z) instanceof TileRoadCover6)){
            super.setBlockBoundsBasedOnState(world,x,y,z);
            return;
        }
        //return based on tile data
        switch(((TileRoadCover6)world.getTileEntity(x,y,z)).dir){
            case 0:
            case 1:
            case 2:
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileRoadCover6(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID+ ":constructionmaterials/tarmac/tarmac_6");
    }
}
