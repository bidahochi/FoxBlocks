...
public class RoadCoverDynamic1X2 extends BlockContainer
{
    public RoadCoverDynamic1X2(Material material)
    {
        super(material);
        setBlockName("roadcover_dynamic_1x2");
        setHardness(2F);
        setResistance(4.0F);
    ...
    {
        return new TileRoadCoverDynamic1X2(meta);
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) 
    {
        ...
        if(world == null || !(world.getTileEntity(x,y,z) instanceof TileRoadCoverDynamic1X2)){
            super.setBlockBoundsBasedOnState(world,x,y,z);
            return;
        }
        //return based on tile data
        switch(((TileRoadCoverDynamic1X2)world.getTileEntity(x,y,z)).dir)
        {
            case 0:
            case 1:
            case 2:
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack)
    {
        ...
        TileRoadCoverDynamic1X2 tile = new TileRoadCoverDynamic1X2(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3);
