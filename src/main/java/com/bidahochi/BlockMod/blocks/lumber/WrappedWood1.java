...
public class WrappedWood1 extends BlockContainer {
    public WrappedWood1(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("WrappedWood1");
        setHardness(2F);
        setResistance(5.0F);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        if(world == null || !(world.getTileEntity(x,y,z) instanceof TileWrappedWood1)){
            super.setBlockBoundsBasedOnState(world,x,y,z);
            return;
        }
        //return based on tile data
        switch(((TileWrappedWood1)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileWrappedWood1(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID+ ":wrappedwood1");
    }
}
