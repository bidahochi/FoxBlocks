...
@SideOnly(Side.CLIENT)
    public class RenderWrappedWood3 extends TileEntitySpecialRenderer {
        private final ResourceLocation texture = new ResourceLocation(FoxBlocks.MODID, "textures/blocks/lumber/wrappedwood/WrappedWood3_Tolko_Straps.png");
        private final Modelwrappedwood model = new Modelwrappedwood();

    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        if(!(tileEntity instanceof TileWrappedWood3)){return;}
        GL11.glPushMatrix();
        ...
        int dir = ((TileWrappedWood3)tileEntity).dir;
