...
public class UnWrappedWood1 extends BlockContainer {
    public UnWrappedWood1(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("UnWrappedWood1");
        setHardness(2F);
        setResistance(5.0F);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        if(world == null || !(world.getTileEntity(x,y,z) instanceof TileUnWrappedWood1)){
            super.setBlockBoundsBasedOnState(world,x,y,z);
            return;
        }
        //return based on tile data
        switch(((TileUnWrappedWood1)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileUnWrappedWood1(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID+ ":unwrappedwood1");
    }
}
