...
@SideOnly(Side.CLIENT)
    public class RenderWrappedWood5 extends TileEntitySpecialRenderer {
        private final ResourceLocation texture = new ResourceLocation(FoxBlocks.MODID, "textures/blocks/lumber/wrappedwood/WrappedWood3_Washaska_Straps2.png");
        private final Modelwrappedwood model = new Modelwrappedwood();

    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        if(!(tileEntity instanceof TileWrappedWood5)){return;}
        GL11.glPushMatrix();
        ...
        int dir = ((TileWrappedWood5)tileEntity).dir;
