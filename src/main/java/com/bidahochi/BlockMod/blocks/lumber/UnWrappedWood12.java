...
public class UnWrappedWood12 extends BlockContainer {
    public UnWrappedWood12(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("UnWrappedWood12");
        setHardness(2F);
        setResistance(5.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileUnWrappedWood12();
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        if(world == null || !(world.getTileEntity(x,y,z) instanceof TileUnWrappedWood12)){
            super.setBlockBoundsBasedOnState(world,x,y,z);
            return;
        }
        //return based on tile data
        switch(((TileUnWrappedWood12)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileUnWrappedWood12(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID+ ":unwrappedwood12");
    }
}
