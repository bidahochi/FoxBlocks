...
public class TileOverhead_hanger_scurve_12 extends TileEntity {
    public int dir=0;

    public TileOverhead_hanger_scurve_12(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_hanger_scurve_12() {}
    ...
    public TileOverhead_hanger_scurve_12 setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
