...
public class TileOverhead_pole_switch_parallelalt extends TileEntity {
    public int dir=0;

    public TileOverhead_pole_switch_parallelalt(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_pole_switch_parallelalt() {}
    ...
    public TileOverhead_pole_switch_parallelalt setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
