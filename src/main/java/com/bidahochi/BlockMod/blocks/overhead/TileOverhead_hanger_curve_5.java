...
public class TileOverhead_hanger_curve_5 extends TileEntity {
    public int dir=0;

    public TileOverhead_hanger_curve_5(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_hanger_curve_5() {}
    ...
    public TileOverhead_hanger_curve_5 setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
