...
public class TileOverhead_hanger_scurve_12alt extends TileEntity {
    public int dir=0;

    public TileOverhead_hanger_scurve_12alt(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_hanger_scurve_12alt() {}
    ...
    public TileOverhead_hanger_scurve_12alt setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
