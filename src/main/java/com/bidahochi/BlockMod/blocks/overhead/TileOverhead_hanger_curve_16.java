...
public class TileOverhead_hanger_curve_16 extends TileEntity {
    public int dir=0;

    public TileOverhead_hanger_curve_16(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_hanger_curve_16() {}
    ...
    public TileOverhead_hanger_curve_16 setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
