...
public class Overhead_hanger_slope_6 extends BlockContainer {
    public Overhead_hanger_slope_6(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("overhead_hanger_slope_6");
        setHardness(2F);
        setResistance(6.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileOverhead_hanger_slope_6();
    }
   ...
   public boolean canCollideCheck(int p_149678_1_, boolean p_149678_2_){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileOverhead_hanger_slope_6(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
