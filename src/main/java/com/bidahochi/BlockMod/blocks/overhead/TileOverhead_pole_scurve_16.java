...
public class TileOverhead_pole_scurve_16 extends TileEntity {
    ...
    public AxisAlignedBB getRenderBoundingBox()
    {
        //z is n/s, x is e/w
        if (dir==0){// north
            return AxisAlignedBB.getBoundingBox(xCoord-1, yCoord, zCoord-16, xCoord + 4, yCoord + 5, zCoord);
        }else if(dir==1){//east
            return AxisAlignedBB.getBoundingBox(xCoord, yCoord, zCoord-1, xCoord+16, yCoord + 5, zCoord + 4);
        }else if(dir==2){//south
            return AxisAlignedBB.getBoundingBox(xCoord-4, yCoord, zCoord, xCoord + 1, yCoord + 5, zCoord + 16);
        }else{//west
            return AxisAlignedBB.getBoundingBox(xCoord-16, yCoord, zCoord-4, xCoord, yCoord + 5, zCoord + 1);
        }
    }
}
