...
public class TileOverhead_hanger_curve_3 extends TileEntity {
    public int dir=0;

    public TileOverhead_hanger_curve_3(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_hanger_curve_3() {}
    ...
    public TileOverhead_hanger_curve_3 setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
