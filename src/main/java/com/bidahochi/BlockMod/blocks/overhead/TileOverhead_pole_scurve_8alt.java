...
public class TileOverhead_pole_scurve_8alt extends TileEntity {
    public int dir=0;

    public TileOverhead_pole_scurve_8alt(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_pole_scurve_8alt() {}
    ...
    public TileOverhead_pole_scurve_8alt setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
