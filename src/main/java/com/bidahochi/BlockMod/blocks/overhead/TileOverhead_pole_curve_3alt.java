...
public class TileOverhead_pole_curve_3alt extends TileEntity {
    public int dir=0;

    public TileOverhead_pole_curve_3alt(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_pole_curve_3alt() {}
    ...
    public TileOverhead_pole_curve_3alt setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
