...
public class TileOverhead_hanger_scurve_8 extends TileEntity {
    public int dir=0;

    public TileOverhead_hanger_scurve_8(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_hanger_scurve_8() {}
    ...
    public TileOverhead_hanger_scurve_8 setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
