...
public class TileOverhead_pole_curve_10 extends TileEntity {
    public int dir=0;

    public TileOverhead_pole_curve_10(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_pole_curve_10() {}
    ...
    public TileOverhead_pole_curve_10 setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
