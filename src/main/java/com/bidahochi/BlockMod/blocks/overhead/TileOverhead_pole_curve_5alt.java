...
public class TileOverhead_pole_curve_5alt extends TileEntity {
    public int dir=0;

    public TileOverhead_pole_curve_5alt(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_pole_curve_5alt() {}
    ...
    public TileOverhead_pole_curve_5alt setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
