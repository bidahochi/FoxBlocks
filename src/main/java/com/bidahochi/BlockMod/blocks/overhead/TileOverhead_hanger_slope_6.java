...
public class TileOverhead_hanger_slope_6 extends TileEntity {
    public int dir=0;

    public TileOverhead_hanger_slope_6(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_hanger_slope_6() {}
    ...
    public TileOverhead_hanger_slope_6 setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
