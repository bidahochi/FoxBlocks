...
public class Overhead_pole_curve_5alt extends BlockContainer {
    public Overhead_pole_curve_5alt(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("overhead_pole_curve_5alt");
        setHardness(2F);
        setResistance(6.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileOverhead_pole_curve_5alt();
    }
   ...
   /* @Override //this doesn't need changing but it needs inclusion
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileOverhead_pole_curve_5alt(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID+ ":overheadlines/icons/5x5_p");
    }
