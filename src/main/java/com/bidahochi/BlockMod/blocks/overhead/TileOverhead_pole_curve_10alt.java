...
public class TileOverhead_pole_curve_10alt extends TileEntity {
    public int dir=0;

    public TileOverhead_pole_curve_10alt(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_pole_curve_10alt() {}
    ...
    public TileOverhead_pole_curve_10alt setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
