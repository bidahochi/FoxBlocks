...
public class TileOverhead_npole_slope_18 extends TileEntity {
    public int dir=0;

    public TileOverhead_npole_slope_18(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_npole_slope_18() {}
    ...
    public TileOverhead_npole_slope_18 setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
