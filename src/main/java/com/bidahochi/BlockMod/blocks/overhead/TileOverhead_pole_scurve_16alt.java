...
public class TileOverhead_pole_scurve_16alt extends TileEntity {
    public int dir=0;

    public TileOverhead_pole_scurve_16alt(int dir) {
        super();
        this.dir = dir;
    }

    public TileOverhead_pole_scurve_16alt() {}
    ...
    public TileOverhead_pole_scurve_16alt setFacing(int direction){
        dir=(byte) direction;
        this.markDirty();
        return this;
    }
