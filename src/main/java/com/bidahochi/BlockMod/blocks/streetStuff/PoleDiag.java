...
public class PoleDiag extends BlockContainer implements IFoxBlocksScrollingBlock {
    public PoleDiag(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("poleDiag");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        /*switch(((TilePoleDiag)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TilePoleDiag(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
