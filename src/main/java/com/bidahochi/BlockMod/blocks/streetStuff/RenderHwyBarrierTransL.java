...
@SideOnly(Side.CLIENT)
    public class RenderHwyBarrierTransL extends TileEntitySpecialRenderer {
        private ResourceLocation texture2 = new ResourceLocation(FoxBlocks.MODID, "textures/blocks/streetstuff/hwy_barrier_transL.png");
        private Modelhwy_barrier_transL model = new Modelhwy_barrier_transL();

        @Override
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileHwyBarrierTransL)){return;}
            GL11.glPushMatrix();
            ...
            int dir = ((TileHwyBarrierTransL)tileEntity).dir;
            switch(dir) {
                case 0:{//west // north
