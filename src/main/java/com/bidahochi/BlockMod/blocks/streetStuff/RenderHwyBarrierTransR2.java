...
@SideOnly(Side.CLIENT)
    public class RenderHwyBarrierTransR2 extends TileEntitySpecialRenderer {
        private ResourceLocation texture2 = new ResourceLocation(FoxBlocks.MODID, "textures/blocks/streetstuff/hwy_barrier_line_transR.png");
        private Modelhwy_barrier_transR model = new Modelhwy_barrier_transR();

        @Override
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileHwyBarrierTransR2)){return;}
            GL11.glPushMatrix();
            ...
            int dir = ((TileHwyBarrierTransR2)tileEntity).dir;
            switch(dir) {
                case 0:{//west // north
