...
public class HwyBarrier2Diag extends BlockContainer implements IFoxBlocksScrollingBlock {
    public HwyBarrier2Diag(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("hwyBarrier2Diag");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileHwyBarrier2Diag();
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        /*switch(((TileHwyBarrier2Diag)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileHwyBarrier2Diag(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID + ":streetstuff/hwy_barrier2_icon_diag");
    }
