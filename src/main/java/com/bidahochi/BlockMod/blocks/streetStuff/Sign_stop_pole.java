...
public class Sign_stop_pole extends BlockContainer {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((TileSign_stop_pole)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileSign_stop_pole(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
