...
public class Sign_stop2_pole extends BlockContainer implements IFoxBlocksScrollingBlock {
    public Sign_stop2_pole(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("sign_stop2_pole");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileSign_stop2_pole();
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((TileSign_stop2_pole)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileSign_stop2_pole(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID + ":streetstuff/sign_stop2_icon");
    }
