...
public class TrafLight_3v extends BlockContainer {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((TileTrafLight_3v)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileTrafLight_3v(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
