...
@SideOnly(Side.CLIENT)
    public class RenderSign_stop2_pole extends TileEntitySpecialRenderer {
        ...
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileSign_stop2_pole)){return;}
            GL11.glPushMatrix();
            Tessellator.bindTexture(texture2);
            GL11.glTranslated(x + 0.5, y + 0.62, z + 0.5);
            GL11.glRotatef(180F, 1F, 0F, 0F);
            GL11.glRotatef(90F, 0F, 1F, 0F);
            int dir = ((TileSign_stop2_pole)tileEntity).dir;
