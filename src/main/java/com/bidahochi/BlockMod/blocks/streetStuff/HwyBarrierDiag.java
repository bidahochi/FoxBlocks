...
public class HwyBarrierDiag extends BlockContainer implements IFoxBlocksScrollingBlock {
    public HwyBarrierDiag(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("hwyBarrierDiag");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        /*switch(((TileHwyBarrierDiag)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileHwyBarrierDiag(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID + ":streetstuff/hwy_barrier_icon_diag");
    }
