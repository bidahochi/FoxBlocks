...
@SideOnly(Side.CLIENT)
    public class RenderTrafLight_3v_nb_diag extends TileEntitySpecialRenderer {
        ...
        public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
            if(!(tileEntity instanceof TileTrafLight_3v_nb_diag)){return;}
            GL11.glPushMatrix();
            Tessellator.bindTexture(texture2);
            GL11.glTranslated(x + 0.5, y + 0.62, z + 0.5);
            GL11.glRotatef(180F, 1F, 0F, 0F);
            GL11.glRotatef(90F, 0F, 1F, 0F);
            int dir = ((TileTrafLight_3v_nb_diag)tileEntity).dir;
            ...
            if (HelperUtils.isFence(tileEntity.getWorldObj(), (int) blockPos.xCoord, (int) blockPos.yCoord, (int) blockPos.zCoord, block)) {
                GL11.glTranslatef(0.04f,0f,0.705f);
            }
            if (block instanceof BlockWall) {
                GL11.glTranslatef(-0.14f,0f,0.705f);
            }
            if (block instanceof Pole || block instanceof PoleHorizontal || block instanceof PoleTransition || block instanceof PoleDiag
                    || block instanceof PoleTransitionDiag || block instanceof PoleHorizontalDiag) {//foxblock pole parts mwahaha
                GL11.glTranslatef(0.14f,0f,0.705f);

                if (block instanceof Pole || block instanceof PoleTransition || block instanceof PoleDiag || block instanceof PoleTransitionDiag){
