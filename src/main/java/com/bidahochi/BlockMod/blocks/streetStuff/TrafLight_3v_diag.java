...
public class TrafLight_3v_diag extends BlockContainer implements IFoxBlocksScrollingBlock {
    public TrafLight_3v_diag(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("trafLight_3v_diag");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileTrafLight_3v_diag();
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((TileTrafLight_3v_diag)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileTrafLight_3v_diag(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID + ":streetstuff/trafLight_3v_black_icon_diag");
    }
