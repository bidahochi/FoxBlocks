...
public class HwyBarrier2 extends BlockContainer implements IFoxBlocksScrollingBlock {
    public HwyBarrier2(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("hwyBarrier2");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((TileHwyBarrier2)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileHwyBarrier2(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID + ":streetstuff/hwy_barrier2_icon");
    }
