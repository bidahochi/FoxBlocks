...
public class Sign_stop2_allway extends BlockContainer implements IFoxBlocksScrollingBlock {
    public Sign_stop2_allway(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("sign_stop2_pole_allway");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileSign_stop2_allway();
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        switch(((TileSign_stop2_allway)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileSign_stop2_allway(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID + ":streetstuff/sign_stop2_allway_icon");
    }
