...
public class HwyBarrierTransL2 extends BlockContainer implements IFoxBlocksScrollingBlock {
    public HwyBarrierTransL2(Material p_i45394_1_) {
        super(p_i45394_1_);
        setBlockName("hwyBarrierTransL2");
        setHardness(2F);
        setResistance(4.0F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileHwyBarrierTransL2();
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        /*switch(((TileHwyBarrierTransL2)world.getTileEntity(x,y,z)).dir){
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack){
        ...
        world.setTileEntity(x,y,z, new TileHwyBarrierTransL2(MathHelper.floor_double((entity.rotationYaw / 90.0F) + 2.5D) & 3));
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        texture = iconRegister.registerIcon(FoxBlocks.MODID + ":streetstuff/hwy_barrier_icon_transL2");
    }
